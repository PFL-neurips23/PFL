...
def load_data(dataset, data_path, device, config_dict):
    if dataset == 'FashionMNIST':
        ...
        folder_name = f"data_alpha_{config_dict['alpha']}_beta_{config_dict['beta']}_iid_{config_dict['iid']}_lnf_{config_dict['label_noise_factor']}_rdf_{config_dict['random_data_fraction_factor']}_lns_{config_dict['label_noise_skew_factor']}_rdfs_{config_dict['random_data_fraction_skew_factor']}"
